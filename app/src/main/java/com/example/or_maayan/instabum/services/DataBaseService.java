...
public class DataBaseService {
    ...
    public void addFeedListener(final GenericCallBack<List<Post>> feedCallback){
        Query feedQuery = feedRef.orderByChild("creation").limitToLast(Constants.FEED_SIZE);
    ...
    public void toggleStartOnPost(Post post) {
       this.toggleStartOnPost(post, new GenericCallBack<Boolean>() {
           @Override
